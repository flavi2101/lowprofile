...
Na documentação descreve que apesar de ser uma cópia, o processo filho tem  PID[^1] diferentes, alguns atributos são reiniciados os valores e algumas area de mémoria não são herdados. Caso queira os detalhes dessas exceções descritas no manual [clique aqui](/lowprofile/data/blog/c_language/pt/excecoes_heranca_fork)
