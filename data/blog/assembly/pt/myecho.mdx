...
é porque se voce digitar no terminal *man echo* voce verá várias opções de como pode ser interpretado a string que esta passando como argumento.
